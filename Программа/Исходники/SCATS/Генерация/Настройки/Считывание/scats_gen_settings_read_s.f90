...
implicit none
     ...
     module procedure scats_gen_settings_read
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WO', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_delta_t', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_q', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_alpha', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_beta', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_A', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_v', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_phi', file)
          ...
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WR_read_gamma', file)

          ! Закрытие файла
          close( unit = unit, iostat = stat )
          if ( stat .ne. 0_SP ) call scats_gen_settings_log_error('WC', file)
