submodule ( scats_gen_m ) scats_gen_generate_random_array_s
implicit none

     contains

     ! Процедура для генерации массива значений нормально распределенных случайных величин
     module procedure scats_gen_generate_random_array
     ...
     end procedure scats_gen_generate_random_array

end submodule scats_gen_generate_random_array_s